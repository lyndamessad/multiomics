...
# On effectuerait donc une analyse multivariée de type PCA afin d'observer une éventuelle corrélation entre les deux.
...
# Dans cette analyse, nous avons des données différents pour des mêmes échantillons.
# La pls serait donc la méthode la plus adaptée car elle va chercher les covariances entres ces différentes données


>>>>>>> 0dea4820dfea6cf89dead9a74d37697221872112
